...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Catalog_Product_Attribute_Edit
    extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit
	{
	}
} else {

	class HTZ_Vendor_Block_Adminhtml_Catalog_Product_Attribute_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
	{
		...
		public function __construct()
		{
			...
			if($vArrId = Mage::getSingleton('eav/config')->getAttribute('catalog_product','vendor_user')->getId()){
				if($vArrId==$this->getRequest()->getParam('attribute_id')){
