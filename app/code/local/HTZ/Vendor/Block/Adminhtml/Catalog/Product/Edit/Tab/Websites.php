...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Catalog_Product_Edit_Tab_Websites
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Websites
	{
	}
} else {
	 
	class HTZ_Vendor_Block_Adminhtml_Catalog_Product_Edit_Tab_Websites extends Mage_Adminhtml_Block_Store_Switcher
	{
