...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Catalog_Category_Tree
    extends Mage_Adminhtml_Block_Catalog_Category_Tree
	{
	}
} else {
	 
	class HTZ_Vendor_Block_Adminhtml_Catalog_Category_Tree extends Mage_Adminhtml_Block_Catalog_Category_Abstract
	{
		...
		public function getCategoryCollection()
		{
			...
			if (is_null($collection)) {
				...
				if($userType == '2' && $userType == '1'){
					$collection->addIdFilter(Mage::helper('vendor')->getUserCategoryIds());
				}
