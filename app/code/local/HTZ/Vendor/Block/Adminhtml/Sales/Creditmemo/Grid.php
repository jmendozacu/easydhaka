...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Sales_Creditmemo_Grid
    extends Mage_Adminhtml_Block_Sales_Creditmemo_Grid
	{
	}
} else {
	 
	class HTZ_Vendor_Block_Adminhtml_Sales_Creditmemo_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		...
		protected function _prepareCollection()
		{
			...
			if($userType == '2'){
				$vendorOrderIds = Mage::helper('vendor')->getVendorOrderIds();
				$collection->addFieldToFilter('order_id', array('in'=>$vendorOrderIds)); 
			} elseif($userType == '1'){
				$collection->addFieldToFilter('store_id', array('in'=>array('in'=>Mage::helper('vendor')->getUserStoreIds()))); 
			}
