...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Sales_Order_Shipment_View
    extends Mage_Adminhtml_Block_Sales_Order_Shipment_View
	{
	}
} else { 
	 
	class HTZ_Vendor_Block_Adminhtml_Sales_Order_Shipment_View extends Mage_Adminhtml_Block_Widget_Form_Container
	{
		...
		public function __construct()
		{
			...
			if (Mage::helper('vendor')->getUserType()=='2'){$this->_removeButton('save');}	
