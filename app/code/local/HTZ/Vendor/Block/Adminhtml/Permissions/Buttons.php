...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Permissions_Buttons
    extends Mage_Adminhtml_Block_Permissions_Buttons
	{
	}
} else {

	class HTZ_Vendor_Block_Adminhtml_Permissions_Buttons extends Mage_Adminhtml_Block_Template
	{
		...
		protected function _prepareLayout()
		{
			...
			$flag = true;
			if($rid = $this->getRequest()->getParam('rid')){
				if(Mage::getModel('admin/role')->load($rid)->getUserType()=='vendor_user'){$flag = false;}			
			}
