...
if($flag){
	class HTZ_Vendor_Block_Adminhtml_Permissions_User_Edit_Tabs
    extends Mage_Adminhtml_Block_Permissions_User_Edit_Tabs
	{
	}
} else {
	 
	class HTZ_Vendor_Block_Adminhtml_Permissions_User_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
	{
		...
		protected function _beforeToHtml()
		{
			...
			if(Mage::getStoreConfig('vendor/settings/enabled')){
				...
				$this->addTab('store_section', array(
					'label'     => Mage::helper('vendor')->__('Stores'),
					'title'     => Mage::helper('vendor')->__('Stores'),
					'content'   => $this->getLayout()->createBlock('adminhtml/permissions_user_edit_tab_store')->toHtml(),
				));
