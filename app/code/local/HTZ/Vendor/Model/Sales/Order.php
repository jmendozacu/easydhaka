 ...
 */
class HTZ_Vendor_Model_Sales_Order extends Mage_Sales_Model_Order
{
    ...
    public function sendNewOrderEmail()
    {
		...
		$storeUser = Mage::helper('vendor')->getStoreUsersOrderEmail($this->getId());
		...
		$vendorUser = Mage::helper('vendor')->getVendorUsersOrderEmail($this->getId());
    ...
    public function sendOrderUpdateEmail($notifyCustomer = true, $comment = '')
    {
		...
		if($flag){
			return parent::sendOrderUpdateEmail($notifyCustomer = true, $comment = '');
		}
