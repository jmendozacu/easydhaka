...
class Cmsmart_Onestepcheckout_IndexController extends Mage_Checkout_Controller_Action
{
    ...
    protected function updateDefaultPayment()
    {
        ...
        // $defaultShippingMethod = Mage::getStoreConfig(self::XML_PATH_DEFAULT_SHIPPING);	
        $_cart = $this->_getCart();
        $_quote = $_cart->getQuote();
		// $_quote->getShippingAddress()->setShippingMethod($defaultShippingMethod);
