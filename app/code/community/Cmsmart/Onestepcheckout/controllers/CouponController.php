...
class Cmsmart_Onestepcheckout_CouponController extends Mage_Core_Controller_Front_Action
{
    ...
    public function couponPostAction()
    {
        ...
        try {
            ...
            $block->setTemplate('cmsmart/onestepcheckout/onepage/coupon.phtml');
